...
test("unconfirmed child cleanup cannot return success or recycle shared capacity", { timeout: 20000 }, async t => {
  ...
  await waitFor(() => f.receipts.length === 1, { timeoutMs: 15000 });
