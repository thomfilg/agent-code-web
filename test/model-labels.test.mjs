...
import { compactModelLabel, modelOptionLabel } from "../public/model-picker.js";
...
test("model option labels retain Codex versions and expose Claude versions from native descriptions", () => {
  ...
  assert.equal(compactModelLabel({ id: "default", label: "Default (recommended)", description: "Opus 5.5 with 1M context · Best for complex tasks" }), "Opus 5.5");
  assert.equal(compactModelLabel({ id: "gpt-5.6-sol", label: "GPT-5.6-Sol", description: "Older coding model." }), "GPT-5.6-Sol");
});
