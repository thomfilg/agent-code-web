...
const commands = { list: async chat => ({ commands: [{ name: "usage", kind: "Web control", web: true }, { name: "goal", kind: "CLI command" }, { name: "work", description: "Installed work skill", kind: "Skill", path: "/fixture/work/SKILL.md" }, { name: "workflow", description: "Workflow plugin", kind: "Skill", path: "/fixture/workflow/SKILL.md" }, ...(chat.agent === "claude" ? [{ name: "claude-only", kind: "CLI command" }] : [])] }) };
...
await app.manager.environments.save({ ...defaultEnvironment, companies: ["acme"], companyId: "acme", allowUnassigned: false, confirmCompanyAssignment: true }, defaultEnvironment.id);
