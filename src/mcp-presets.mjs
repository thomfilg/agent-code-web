...
export const MCP_PRESETS = [
  ...
  { id: "atlassian", name: "Atlassian", description: "Jira, Confluence and Bitbucket", url: "https://mcp.atlassian.com/v2/mcp", authMode: "oauth", docs: "https://support.atlassian.com/atlassian-ai-gateway/docs/get-started-with-the-atlassian-remote-mcp-server/" },
